 ...
 *     @OA\Property(property="fecha_afiliacion_efectiva", type="string", format="date", example="2023-01-15"),
 *     @OA\Property(property="fecha_finalizacion_afiliacion", type="string", format="date", example="2025-01-15"),
 *     @OA\Property(property="tipo_afiliado", type="string", example="titular"),
 *     @OA\Property(property="numero_afiliado", type="string", example="AF123456")
 * )
 */
  ...
  /**
 * @OA\Get(
 *     path="/aspirante/obtener-eps",
 *     tags={"EPS"},
 *     summary="Obtener EPS del usuario autenticado",
 *     security={{"bearerAuth": {}}},
 *     @OA\Response(
 *         response=200,
 *         description="Información de la EPS obtenida",
 *         @OA\JsonContent(ref="#/components/schemas/EPS")
 *     ),
 *     @OA\Response(
 *         response=401,
...
/**
 * @OA\Put(
 *     path="/aspirante/actualizar-eps",
 *     tags={"EPS"},
 *     summary="Actualizar EPS del usuario",
 *     security={{"bearerAuth": {}}},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\MediaType(
 *             mediaType="multipart/form-data",
 *             @OA\Schema(
 *                 required={"nombre_eps", "tipo_afiliacion", "estado_afiliacion", "fecha_afiliacion_efectiva", "tipo_afiliado"},
 *                 @OA\Property(property="nombre_eps", type="string", example="Nueva EPS"),
 *                 @OA\Property(property="tipo_afiliacion", type="string", example="subsidiado"),
 *                 @OA\Property(property="estado_afiliacion", type="string", example="activo"),
 *                 @OA\Property(property="fecha_afiliacion_efectiva", type="string", format="date", example="2024-04-15"),
 *                 @OA\Property(property="tipo_afiliado", type="string", example="titular"),
 ...
 *     @OA\Response(
 *         response=500,
 *         description="Error al actualizar la EPS"
 *     )
 * )
 */
